...
_STRINGS = {
    ...
    "sample.admin.title": {LANG_EN: "01 Sample & Standard Studio", LANG_ZH: "01 样品与标准工作室", LANG_JA: "01 サンプルと標準スタジオ"},
    ...
    "studio.header.title": {
        LANG_EN: "02 Digital QC Studio",
        LANG_ZH: "02 数字质检工作室",
        LANG_JA: "02 デジタル QC スタジオ",
    },
    ...
    "studio.js.training_sample_source": {LANG_EN: "Specimen selected from 01 Sample & Standard; capture the test piece from the USB stream below.", LANG_ZH: "已选择 01 样品与标准中的标本；请在下方 USB 视频流中采集测试品。", LANG_JA: "01 サンプルと標準で標本を選択し、下の USB ストリームから検査品を撮影します。"},
    "studio.js.training_submit_sample": {LANG_EN: "Capture test piece and run CV + VLM", LANG_ZH: "采集测试品并运行 CV+VLM 判断", LANG_JA: "検査品を撮影して CV+VLM 判定を実行"},
    ...
    "studio.training.camera.heading": {LANG_EN: "02 Digital QC Studio · USB test-piece stream", LANG_ZH: "02 数字质检工作室 · USB 测试品视频流", LANG_JA: "02 デジタル QC スタジオ · USB 検査品ストリーム"},
    "studio.training.camera.instructions": {LANG_EN: "Select a specimen on the left first, then position the physical test piece in the USB camera stream.", LANG_ZH: "请先在左侧选择标本，再将实际测试品置于 USB 摄像机视频流中。", LANG_JA: "左側で標本を選択してから、実際の検査品を USB カメラに映してください。"},
    "studio.training.camera.start": {LANG_EN: "Start USB camera", LANG_ZH: "启动 USB 摄像头", LANG_JA: "USB カメラを開始"},
    "studio.training.camera.capture": {LANG_EN: "Capture test piece", LANG_ZH: "截取测试品", LANG_JA: "検査品を撮影"},
    "studio.training.camera.stop": {LANG_EN: "Stop camera", LANG_ZH: "停止摄像头", LANG_JA: "カメラを停止"},
    "studio.training.camera.ready": {LANG_EN: "USB camera stream ready.", LANG_ZH: "USB 摄像机视频流已就绪。", LANG_JA: "USB カメラストリーム準備完了。"},
    "studio.training.camera.denied": {LANG_EN: "USB camera unavailable or permission denied:", LANG_ZH: "USB 摄像头不可用或权限被拒绝：", LANG_JA: "USB カメラを利用できないか、権限が拒否されました："},
    "studio.training.camera.captured": {LANG_EN: "Test piece captured; judgment is awaiting administrator review.", LANG_ZH: "测试品已截取，等待管理员裁决。", LANG_JA: "検査品を撮影しました。管理者レビュー待ちです。"},
    "studio.training.camera.required": {LANG_EN: "Start the USB camera after selecting a specimen.", LANG_ZH: "选择标本后，请启动 USB 摄像头。", LANG_JA: "標本を選択して USB カメラを開始してください。"},
    "studio.training.camera.failed": {LANG_EN: "The live USB frame is not ready; adjust the camera and retry.", LANG_ZH: "USB 实时画面尚未就绪，请调整摄像头后重试。", LANG_JA: "USB ライブ映像が準備できていません。カメラを調整して再試行してください。"},
    "studio.training.capture_sku_first": {LANG_EN: "Select a specimen/SKU from 01 Sample & Standard first.", LANG_ZH: "请先从 01 样品与标准选择标本/SKU。", LANG_JA: "先に 01 サンプルと標準から標本/SKU を選択してください。"},
