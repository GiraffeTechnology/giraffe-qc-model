...
_STRINGS = {
    ...
    "studio.workflow.publish": {LANG_EN: "5 Publish", LANG_ZH: "5 发布", LANG_JA: "5 公開"},
    "studio.workflow.install": {LANG_EN: "6 Install", LANG_ZH: "6 安装", LANG_JA: "6 インストール"},
    "studio.nav.qc_model": {
    ...
    "pad.inspection.camera_timeout": {LANG_EN: "Camera permission timed out. Allow camera access in Chrome and retry.", LANG_ZH: "摄像头授权超时。请在 Chrome 中允许摄像头访问后重试。", LANG_JA: "カメラ権限がタイムアウトしました。Chrome で許可して再試行してください。"},
