...
_STRINGS = {
    ...
    "sample.workflow.label": {LANG_EN: "Sample workflow", LANG_ZH: "样品工作流", LANG_JA: "サンプルワークフロー"},
    "sample.workflow.title": {LANG_EN: "Sample Management Workbench", LANG_ZH: "样品管理工作室", LANG_JA: "サンプル管理ワークベンチ"},
    "sample.workflow.subtitle": {
        LANG_EN: "Enter the sample and confirm its detection points here.",
        LANG_ZH: "在此完成样品录入和检测点确认。",
        LANG_JA: "ここでサンプル登録と検出ポイント確認を行います。",
    },
    "sample.workflow.capture": {
        LANG_EN: "1 Sample entry",
        LANG_ZH: "1 样品录入",
        LANG_JA: "1 サンプル登録",
    },
    "sample.workflow.confirm": {
        LANG_EN: "2 Detection-point confirmation",
        LANG_ZH: "2 检测点确认",
        LANG_JA: "2 検出ポイント確認",
    },
    ...
    "studio.workflow.label": {LANG_EN: "Training and publishing workflow", LANG_ZH: "培训发布工作流", LANG_JA: "トレーニング・公開フロー"},
    "studio.workflow.title": {LANG_EN: "Digital QC Workbench", LANG_ZH: "数字质检工作室", LANG_JA: "デジタル品質検査ワークベンチ"},
    "studio.workflow.subtitle": {
        LANG_EN: "Run administrator-reviewed training, then publish the qualified standard.",
        LANG_ZH: "在此完成管理员审核的培训，通过后发布标准。",
        LANG_JA: "管理者レビュー付きトレーニングを行い、合格後に標準を公開します。",
    },
    "studio.workflow.training": {LANG_EN: "1 Training", LANG_ZH: "1 培训", LANG_JA: "1 トレーニング"},
