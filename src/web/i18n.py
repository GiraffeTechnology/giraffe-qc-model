...
_STRINGS = {
    ...
    "studio.workflow.label": {LANG_EN: "Standard authoring workflow", LANG_ZH: "标准创建流程", LANG_JA: "標準作成フロー"},
    "studio.workflow.title": {LANG_EN: "Train a Digital Inspector", LANG_ZH: "训练数字质检员", LANG_JA: "デジタル検査員をトレーニング"},
    "studio.workflow.subtitle": {
        LANG_EN: "Describe the product as you would to a colleague; the assistant drafts and you approve.",
        LANG_ZH: "像向同事交代工作一样描述产品；助手生成草案，由你审核确认。",
        LANG_JA: "同僚に説明するように製品を記述し、アシスタントの草案を確認します。",
    },
    "studio.workflow.sku": {LANG_EN: "1 SKU", LANG_ZH: "1 SKU", LANG_JA: "1 SKU"},
    "studio.workflow.photo": {LANG_EN: "2 Reference photo", LANG_ZH: "2 标准照片", LANG_JA: "2 標準写真"},
    "studio.workflow.requirements": {LANG_EN: "3 Requirements", LANG_ZH: "3 质检要求", LANG_JA: "3 要件"},
    "studio.workflow.review": {LANG_EN: "4 Review", LANG_ZH: "4 审核确认", LANG_JA: "4 レビュー"},
    "studio.workflow.training": {LANG_EN: "5 Training", LANG_ZH: "5 训练", LANG_JA: "5 トレーニング"},
    "studio.workflow.publish": {LANG_EN: "6 Publish", LANG_ZH: "6 发布", LANG_JA: "6 公開"},
    "studio.workflow.install": {LANG_EN: "7 Install", LANG_ZH: "7 安装", LANG_JA: "7 インストール"},
    "studio.nav.qc_model": {
    ...
    "studio.js.publish_blocked_by_training": {
        LANG_EN: "Publish is blocked until training qualifies (last 29 all correct, or last 30 with at least 29 correct, covering both qualified and unqualified samples, zero false passes).",
        LANG_ZH: "训练未合规前不得发布（最近连续 29 次全部正确，或最近 30 次至少 29 次正确，且需覆盖合格与不合格样本、窗口内 False pass 为 0）。",
        LANG_JA: "トレーニングが合格するまで公開はブロックされます（直近29件全て正解、または直近30件中29件以上正解、かつ合格・不合格サンプルの両方を含み、フォールスパスがゼロであること）。",
    },
    ...
    "pad.inspection.evidence": {LANG_EN: "Simulated evidence", LANG_ZH: "模拟证据", LANG_JA: "模擬証拠"},
