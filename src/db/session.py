...
def init_db() -> None:
    ...
    import src.db.qc_probation_models  # noqa: F401 — side-effect import registers tables
    ...
    import src.db.qc_verdict_models  # noqa: F401 — side-effect import registers tables
    ...
    import src.db.qc_jetson_models  # noqa: F401 — side-effect import registers tables
