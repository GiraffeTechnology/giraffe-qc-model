 ...
 *
 * S0 deliverable. S5/S6 implement this interface against SQLite; it is the only
 * surface the Pad UI reads installed standards through. All lookups are strictly
 * offline — they never touch the network. A miss returns null / empty (never an
 * exception), so callers can fail closed.
 *
