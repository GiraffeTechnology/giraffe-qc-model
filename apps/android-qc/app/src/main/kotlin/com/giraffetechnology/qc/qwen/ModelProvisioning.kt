...
data class ProvisioningConfig(
    ...
    // Default: Qwen3-VL-2B-Instruct-MNN (INT4) — suitable for 8GB RAM Snapdragon 8 Gen devices.
 ...
 *
 * Hardware note: Qwen3-VL-2B-Instruct-MNN (INT4) requires ~8GB device RAM.
